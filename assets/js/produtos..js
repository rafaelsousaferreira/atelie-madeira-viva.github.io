...
const productsDB = [
  // Utensílios
  {
    ...
    descricao_completa: "<p>Esta tábua de corte foi fabricada com madeira de demolição de alta densidade, garantindo durabilidade e resistência.</p><p><strong>Características:</strong></p><ul><li>Madeira: Peroba Rosa</li><li>Dimensões: 40cm x 30cm x 2cm</li><li>Acabamento com óleo mineral</li><li>Pés antiderrapantes</li><li>Sulco para coleta de líquidos</li></ul>",
    imagens: [
