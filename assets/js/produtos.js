...
const productsDB = [
  // Utensílios
  {
    ...
    descricao_completa: "<p>A Tábua de Madeira Macica 50x15,5x2cm com azulejo personalizado é a escolha ideal para quem valoriza a qualidade e a estética na cozinha. Feita de madeira nobre, esta tábua combina durabilidade e elegancia, tornando-se um item indispensável para o preparo de suas receitas favoritas. Seu design retangular proporciona um amplo espaco para cortar e preparar alimentos com facilidade. O azulejo personalizado permite que voce adicione um toque pessoal, tornando a tábua nao apenas funcional, mas também uma peca decorativa. Com dimensoes de 50 cm de comprimento e 15,5 cm de largura, é perfeita para qualquer tipo de cozinha, seja ela moderna ou tradicional. Além disso, a espessura de 2 mm garante resistencia e estabilidade durante o uso. Embora nao possua características como antiderrapante ou canaleta, sua superfície lisa facilita a limpeza e o manuseio. É importante ressaltar que a tábua é livre de BPA, garantindo seguranca na preparacao dos alimentos. Ideal para presentear ou para uso pessoal, esta tábua é uma adicao valiosa a sua colecao de utensílios de cozinha. Garantia do vendedor: 1 meses</p><p><strong>Características:</strong></p><ul><li>Madeira: Nobre</li><li>Dimensões: 50cm x 15cm, 5x2cm</li><li>Acabamento com óleo mineral</li><li>Pés antiderrapantes</li><li>Sulco para coleta de líquidos</li></ul>",
    imagens: [
